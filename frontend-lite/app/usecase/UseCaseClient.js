    ...
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {HERO_STATS.map((stat) => (
            ...
            >
              ...
              <span className="text-[10px] text-zinc-400 uppercase tracking-[0.14em] font-semibold">
                {stat.label}
              </span>
            </div>
          ))}
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-3 mb-10">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">The case for Markdown</p>
          ...
          {VALUE_PROPS.map((vp) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-semibold text-zinc-900 leading-snug">{vp.title}</h3>
              </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center">
              <p className="text-[10px] uppercase tracking-[0.14em] text-zinc-400 font-semibold mb-2">Raw PDF</p>
              <div className="text-4xl md:text-5xl font-black text-red-400/80">~15K</div>
              <p className="text-xs text-zinc-400 mt-1">tokens per document</p>
            </div>
            ...
            {/* After */}
            <div className="flex-1 text-center">
              <p className="text-[10px] uppercase tracking-[0.14em] text-zinc-400 font-semibold mb-2">Clean Markdown</p>
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-3 mb-10">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Who it's for</p>
          ...
          {USE_CASES.map((uc) => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <h3 className="text-sm font-semibold text-zinc-900 mt-2">{uc.title}</h3>
              </div>
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-3 mb-10">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">All file types supported</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {FILE_TYPES.map((ft) => (
            ...
            >
              ...
              <span className="text-[10px] text-zinc-400 leading-tight">{ft.desc}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-3 mb-10">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Workflow</p>
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-3 mb-8">
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Under the hood</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-zinc-900">Frontend</h3>
            </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-zinc-900">Backend</h3>
            </div>
            <div className="flex flex-wrap gap-2">
